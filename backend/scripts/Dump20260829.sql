...
fbab4a2c-a8f6-11f0-8e6c-00163e32338b:1-5355749';
...
CREATE TABLE `accident` (
  ...
  `severity` tinyint DEFAULT NULL COMMENT '严重程度：1轻/2中/3重',
  `handle_result` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '处理结果/整改措施',
  `handle_staff_id` bigint unsigned DEFAULT NULL COMMENT '处理责任人id',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_accident_tenant` (`tenant_id`,`elder_id`,`occur_date`),
  KEY `idx_elder` (`elder_id`),
  KEY `idx_staff` (`staff_id`),
  KEY `idx_occur` (`occur_date`)
...
CREATE TABLE `bed` (
  ...
  `status` tinyint unsigned NOT NULL COMMENT '床位状态(空闲/预定/入住/退住审核/维修)',
...
CREATE TABLE `bill` (
  ...
  `status` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '状态：0-未支付，1-部分支付，2-已支付，3-逾期',
...
CREATE TABLE `consume` (
  ...
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
  `update_time` datetime NOT NULL COMMENT '修改时间',
  `source_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'MANUAL' COMMENT '来源：ORDER/NURSE_RESERVE/MANUAL',
  `source_id` bigint unsigned DEFAULT NULL COMMENT '来源业务主键id',
  `out_trade_no` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '外部交易单号（对账）',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_consume_tenant` (`tenant_id`,`elder_id`,`consume_date`),
  KEY `idx_elder_time` (`elder_id`,`consume_date`),
...
INSERT INTO `consume` VALUES (1,1,1,'护理',100,'2023-01-07 18:47:51',1,'2023-01-07 18:47:57',1,'2023-01-07 18:48:01','MANUAL',NULL,NULL),(2,1,2,'点餐',100,'2023-01-07 18:47:51',1,'2023-01-07 18:47:57',1,'2023-01-07 18:48:01','MANUAL',NULL,NULL),(3,1,2,'护理',240,'2022-12-13 00:00:00',1,'2023-01-12 23:44:33',1,'2023-01-12 23:44:33','MANUAL',NULL,NULL),(4,1,2,'点餐',6,'2022-12-14 00:00:00',1,'2023-01-14 21:09:05',1,'2023-01-14 21:09:05','MANUAL',NULL,NULL),(5,1,1,'护理',12,'2023-04-04 00:00:00',1,'2023-04-04 10:14:06',1,'2023-04-04 10:14:06','MANUAL',NULL,NULL),(6,1,1,'点餐',3,'2023-04-04 00:00:00',1,'2023-04-04 16:35:29',1,'2023-04-04 16:35:29','MANUAL',NULL,NULL),(7,1,1,'点餐',2,'2023-04-13 00:00:00',1,'2023-04-05 19:34:28',1,'2023-04-05 19:34:28','MANUAL',NULL,NULL),(8,1,1,'护理',12,'2023-04-24 00:00:00',1,'2023-04-24 19:36:54',1,'2023-04-24 19:36:54','MANUAL',NULL,NULL);
...
CREATE TABLE `drug_deposit` (
  ...
  `status` tinyint unsigned NOT NULL COMMENT '缴存状态',
  `state` tinyint NOT NULL DEFAULT '1' COMMENT '管理状态：-1=删除，0=禁用，1=可用',
  `create_id` bigint unsigned NOT NULL COMMENT '创建人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
...
CREATE TABLE `elder` (
  ...
  `status` tinyint unsigned NOT NULL COMMENT '入住状态',
  `create_id` bigint unsigned NOT NULL COMMENT '创建人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
  `update_time` datetime NOT NULL COMMENT '修改时间',
...
--
-- Table structure for table `elder_account_ledger`
--

DROP TABLE IF EXISTS `elder_account_ledger`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `elder_account_ledger` (
  ...
  `source_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '来源类型：BILL_INCOME/RECHARGE/FEED/NURSING/REFUND...',
  `source_id` bigint unsigned NOT NULL COMMENT '来源业务表主键id',
  `business_no` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务单号（可空，用于人工对账）',
...
--
-- Dumping data for table `elder_account_ledger`
--

LOCK TABLES `elder_account_ledger` WRITE;
/*!40000 ALTER TABLE `elder_account_ledger` DISABLE KEYS */;
/*!40000 ALTER TABLE `elder_account_ledger` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `emergency_contact` (
  ...
  `relation` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '与老人关系',
  `is_receive` tinyint unsigned NOT NULL COMMENT '是否接收消息',
  `create_id` bigint unsigned NOT NULL COMMENT '创建人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
  `update_time` datetime NOT NULL COMMENT '修改时间',
...
CREATE TABLE `family_member` (
  ...
  `address` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '地址',
  `relation` varchar(5) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '与老人关系',
  `is_receive` tinyint NOT NULL COMMENT '是否接收消息',
  `state` tinyint NOT NULL DEFAULT '1' COMMENT '管理状态：-1=删除，0=禁用，1=可用',
  `create_id` bigint unsigned NOT NULL COMMENT '创建人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
...
) ENGINE=InnoDB AUTO_INCREMENT=813 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='字段中文名字典';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `member` (
  ...
  `status` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '状态：0在职 1离职',
...
CREATE TABLE `nurse` (
  ...
  `complete_status` tinyint unsigned NOT NULL COMMENT '护理完成情况',
  `dine_status` tinyint unsigned NOT NULL COMMENT '进餐情况',
...
CREATE TABLE `order` (
  ...
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
  `update_time` datetime NOT NULL COMMENT '修改时间',
  `out_trade_no` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '对外交易单号',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `order` VALUES (1,1,2,5,'2022-12-13 00:00:00','2022-12-14 00:00:00','送餐',6,1,1,'2023-01-14 20:51:41',1,'2023-01-14 21:09:05',NULL),(2,1,1,6,'2023-04-05 00:00:00','2023-04-04 00:00:00','送餐',3,1,1,'2023-04-04 16:34:45',1,'2023-04-04 16:35:29',NULL),(3,1,1,6,'2023-04-12 00:00:00','2023-04-13 00:00:00','堂食',2,1,1,'2023-04-05 19:34:09',1,'2023-04-05 19:34:28',NULL),(4,1,1,NULL,NULL,'2023-04-07 17:23:55','送餐',0,0,1,'2023-04-07 17:24:16',1,'2023-04-07 17:24:16',NULL),(5,1,1,NULL,NULL,'2023-04-22 00:00:00','送餐',10,0,1,'2023-04-14 18:14:39',1,'2023-04-14 18:14:39',NULL);
...
CREATE TABLE `order_dishes` (
  ...
  `status` tinyint unsigned NOT NULL COMMENT '套餐标记',
...
CREATE TABLE `outbound_record` (
  ...
  `status` tinyint unsigned NOT NULL COMMENT '出库状态',
  `state` tinyint NOT NULL DEFAULT '1' COMMENT '管理状态：-1=删除，0=禁用，1=可用',
  `create_id` bigint unsigned NOT NULL COMMENT '创建人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
...
CREATE TABLE `reserve` (
  ...
  `status` tinyint unsigned NOT NULL COMMENT '退款状态（N/Y）',
  `create_id` bigint unsigned NOT NULL COMMENT '创建人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
  `update_time` datetime NOT NULL COMMENT '修改时间',
...
CREATE TABLE `retreat_apply` (
  ...
  `tenant_id` bigint unsigned NOT NULL DEFAULT '1' COMMENT '租户id',
  `elder_id` bigint unsigned NOT NULL COMMENT '老人id',
  `status` tinyint unsigned NOT NULL COMMENT '业务状态(退住申请流程状态)',
  `state` tinyint NOT NULL DEFAULT '1' COMMENT '管理状态：-1=删除，0=禁用，1=正常',
  `create_id` bigint unsigned NOT NULL COMMENT '创建人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
...
CREATE TABLE `room` (
  ...
  `status` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '状态：0-空闲，1-部分占用，2-全满，3-维修',
...
CREATE TABLE `staff` (
  ...
  `address` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '地址',
  `status` tinyint unsigned NOT NULL COMMENT '状态：0-离职，1-在职',
  `create_id` bigint unsigned NOT NULL COMMENT '创建人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
  `update_time` datetime NOT NULL COMMENT '修改时间',
...
CREATE TABLE `tenant` (
  ...
  `status` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '状态：0试用中 1正式 2锁定',
...
CREATE TABLE `visit` (
  ...
  `status` tinyint unsigned NOT NULL COMMENT '来访状态',
...
CREATE TABLE `warehouse_record` (
  ...
  `status` tinyint unsigned NOT NULL COMMENT '入库状态',
  `state` tinyint NOT NULL DEFAULT '1' COMMENT '管理状态：-1=删除，0=禁用，1=可用',
  `create_id` bigint unsigned NOT NULL COMMENT '创建人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_id` bigint unsigned NOT NULL COMMENT '修改人id',
...
-- Dump completed on 2026-08-31  9:43:46
