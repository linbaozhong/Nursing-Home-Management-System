...
fbab4a2c-a8f6-11f0-8e6c-00163e32338b:1-5290132';
...
CREATE TABLE `field_dict` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_table_field` (`table`,`field`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='字段中文名字典';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `field_dict` VALUES (1,'accident','id','编号'),(2,'accident','staff_id','值班护工'),(3,'accident','occur_date','发生时间'),(4,'accident','description','事故描述'),(5,'accident','picture','事故图片'),(6,'accident','elder_id','老人'),(7,'accident','state','管理状态');
...
CREATE TABLE `staff` (
  ...
  `avator` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '头像',
  `address` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '地址',
...
CREATE TABLE `user` (
  ...
  `avator` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '头像',
  `create_time` datetime NOT NULL COMMENT '创建时间',
...
-- Dump completed on 2026-08-27 15:37:36
