...
// GetBuildingResp 床位全景-楼栋树响应
type GetBuildingResp = BuildingResp

// ListFloorByBuildingIdReq 根据楼栋编号获取楼层列表请求
// @request
type ListFloorByBuildingIdReq struct {
	BuildingID *int64 `json:"building_id" form:"building_id"` // 楼栋编号
}

// // @request
// // ListRoomByKeyReq 获取房间列表请求（对应 Java ListRoomByKeyReq）
