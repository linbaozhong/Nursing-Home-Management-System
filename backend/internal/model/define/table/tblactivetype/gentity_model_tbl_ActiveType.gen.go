...
var (
	...
	TenantId   = dialect.Field{Name: "tenant_id", Json: "tenant_id", Table: "active_type", Type: "types.BigInt", IsRelation: false}
	...
	State      = dialect.Field{Name: "state", Json: "state", Table: "active_type", Type: "types.Int8", IsRelation: false}
	// 主键
	PrimaryKey = Id
