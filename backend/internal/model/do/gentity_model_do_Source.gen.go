...
var sourceFieldToPtrFunc = map[string]func(*Source) any{
	...
	tblsource.TenantId.Name:   func(p *Source) any { return &p.TenantId },
	...
	tblsource.State.Name:      func(p *Source) any { return &p.State },
}
...
var sourceFieldToValueFunc = map[dialect.Field]func(*Source) (any, bool){
	...
	tblsource.TenantId: func(p *Source) (any, bool) {
	...
	tblsource.State: func(p *Source) (any, bool) {
