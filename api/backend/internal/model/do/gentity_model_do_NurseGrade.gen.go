...
const NurseGradeTableName = "nurse_grade"
...
func (p *NurseGrade) Scan(rows *sql.Rows, args ...dialect.Field) ([]*NurseGrade, bool, error) {
	defer rows.Close()
...
func (p *NurseGrade) AssignValues(d dialect.Dialect, args ...dialect.Field) ([]string, []any) {
	...
	for _, arg := range args {
		if valueFunc, exists := nursegradeFieldToValueFunc[arg]; exists {
