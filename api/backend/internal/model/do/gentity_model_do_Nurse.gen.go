...
func (p *Nurse) Scan(rows *sql.Rows, args ...dialect.Field) ([]*Nurse, bool, error) {
	defer rows.Close()
	nurses := make([]*Nurse, 0)
...
func (p *Nurse) AssignValues(d dialect.Dialect, args ...dialect.Field) ([]string, []any) {
	...
	for _, arg := range args {
		if valueFunc, exists := nurseFieldToValueFunc[arg]; exists {
