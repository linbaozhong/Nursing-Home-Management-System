...
const HealthInfoTableName = "health_info"
...
func (p *HealthInfo) Scan(rows *sql.Rows, args ...dialect.Field) ([]*HealthInfo, bool, error) {
	defer rows.Close()
...
func (p *HealthInfo) AssignValues(d dialect.Dialect, args ...dialect.Field) ([]string, []any) {
	...
	for _, arg := range args {
		if valueFunc, exists := healthinfoFieldToValueFunc[arg]; exists {
