...
const ConsultTableName = "consult"
...
func (p *Consult) Scan(rows *sql.Rows, args ...dialect.Field) ([]*Consult, bool, error) {
	defer rows.Close()
...
func (p *Consult) AssignValues(d dialect.Dialect, args ...dialect.Field) ([]string, []any) {
	...
	for _, arg := range args {
		if valueFunc, exists := consultFieldToValueFunc[arg]; exists {
