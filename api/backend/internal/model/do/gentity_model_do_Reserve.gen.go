...
const ReserveTableName = "reserve"
...
func (p *Reserve) Scan(rows *sql.Rows, args ...dialect.Field) ([]*Reserve, bool, error) {
	defer rows.Close()
...
func (p *Reserve) AssignValues(d dialect.Dialect, args ...dialect.Field) ([]string, []any) {
	...
	for _, arg := range args {
		if valueFunc, exists := reserveFieldToValueFunc[arg]; exists {
