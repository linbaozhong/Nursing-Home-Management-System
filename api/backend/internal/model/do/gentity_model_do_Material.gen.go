...
// const MaterialTableName = "material"
...
func (p *Material) Scan(rows *sql.Rows, args ...dialect.Field) ([]*Material, bool, error) {
	defer rows.Close()
...
func (p *Material) AssignValues(d dialect.Dialect, args ...dialect.Field) ([]string, []any) {
	...
	for _, arg := range args {
		if valueFunc, exists := materialFieldToValueFunc[arg]; exists {
