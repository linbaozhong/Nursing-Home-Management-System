...
type PageMaterialByKeyQuery struct {
	...
	MaterialTypeID *int64  `json:"materialTypeId"` // 物资分类编号
...
type OperateMaterialQuery struct {
	ID     *int64   `json:"id"` // id
	TypeID *int64   `json:"typeId" valid:"required"` // typeId
...
type AddMaterialQuery struct {
	ID     *int64   `json:"id"` // id
	TypeID *int64   `json:"typeId" valid:"required"` // 物资分类编号
	Name   *string  `json:"name" valid:"required"` // 物资名称
	Price  *float64 `json:"price" valid:"required"` // 物资单价
...
type PageMaterialByKeyVO struct {
	...
	TypeName string  `json:"typeName"` // 物资分类
